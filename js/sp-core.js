    ...
    if (nav) {
      ...
      const navSections = [
        ...
        { id:'finance', title:'FINANCE', items:[
          ...
          { href:'amortization.html', icon:'fa-calendar-alt', label:'Amortization' },
          { href:'cap-rate.html', icon:'fa-percent', label:'Cap Rate' },
          { href:'rehab-estimator.html', icon:'fa-hammer', label:'Rehab Estimator' },
          { href:'tax-appeal.html', icon:'fa-gavel', label:'Tax Appeal' },
          { href:'insurance-tracker.html', icon:'fa-shield-alt', label:'Insurance Tracker' },
        ], overflow:[
        ...
        { id:'gp', title:'GP TOOLS', items:[
          ...
          { href:'turnover-report.html', icon:'fa-users-slash', label:'Turnover' },
          { href:'vendor-invoice.html', icon:'fa-file-invoice-dollar', label:'Vendor Invoice' },
          { href:'capital-events.html', icon:'fa-chart-bar', label:'Capital Events' },
          { href:'investor-statement.html', icon:'fa-envelope-open-text', label:'Investor Statement' },
          { href:'cash-forecast.html', icon:'fa-chart-line', label:'Cash Forecast' },
          { href:'rent-comps.html', icon:'fa-building', label:'Rent Comps' },
          { href:'ltc-calc.html', icon:'fa-calculator', label:'LTC Calculator' },
          { href:'dscr-calc.html', icon:'fa-balance-scale', label:'DSCR Calculator' },
          { href:'occupancy-tracker.html', icon:'fa-th-large', label:'Occupancy' },
          { href:'maintenance-log.html', icon:'fa-wrench', label:'Maintenance' },
          { href:'capex-planner.html', icon:'fa-hammer', label:'CapEx' },
          { href:'property-tax-tracker.html', icon:'fa-landmark', label:'Property Tax' },
          { href:'loan-maturity.html', icon:'fa-hourglass-end', label:'Maturity Watch' },
        ...
        { id:'ops', title:'OPERATIONS', items:[
          ...
          { href:'utility-tracker.html', icon:'fa-bolt', label:'Utilities' },
          { href:'tenant-directory.html', icon:'fa-users', label:'Tenants' },
          { href:'insurance-claims.html', icon:'fa-file-contract', label:'Claims' },
