...
<div style="text-align: center !important; margin-bottom: 48px;">
  <p style="font-size: 14pt; font-weight: bold; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 24px; text-align: center !important;">LIMITED LIABILITY COMPANY OPERATING AGREEMENT</p>
  <p style="font-size: 11pt; margin-bottom: 4px; text-align: center !important;">OF</p>
  <p style="font-size: 14pt; font-weight: bold; margin-bottom: 16px; text-align: center !important;">${companyName}</p>
  <p style="font-size: 11pt; text-align: center !important;">A ${state} Limited Liability Company</p>
  <p style="font-size: 11pt; margin-top: 16px; text-align: center !important;">Dated as of ${today}</p>
</div>
