...
${[
  ...
  ['Article IX', 'Buyout of Membership Interest'],
  ['Article X', 'Expulsion of a Member'],
  ['Article XI', 'Accounting, Records, and Tax Matters'],
  ['Article XII', 'Additional Capital and Default'],
  ['Article XIII', 'Dissolution and Winding Up'],
  ['Article XIV', 'State-Specific Provisions'],
...
<ol type="i" style="margin-left: 20px;">
  ...
  <li>Dissolution or winding up of the Company (except as provided in Article XIII);</li>
...
<p><strong>8.6 Permitted Transfers.</strong> Notwithstanding Sections 8.1 and 8.2, a Member may Transfer all or any portion of such Member's Interest without the prior consent of the other Members to: (a) a revocable trust established by such Member for estate planning purposes of which such Member is a trustee or beneficiary; (b) any entity wholly owned by such Member; or (c) a member of such Member's immediate family (spouse, children, or grandchildren); provided that (i) the transferee executes an instrument satisfactory to the Managing Member accepting and adopting the terms and provisions of this Agreement, and (ii) the transferring Member notifies the Managing Member in writing at least ten (10) days prior to the proposed Transfer.</p>

<p style="${hdr}">ARTICLE IX<br>BUYOUT OF MEMBERSHIP INTEREST</p>
<p><strong>9.1 Death or Disability of a Member.</strong> Upon the death or permanent disability (as determined by a licensed physician) of a Member who is a natural person, the Company shall have the option, exercisable within sixty (60) days after receipt of written notice of such event, to purchase all of the deceased or disabled Member's Interest at Fair Value (determined as of the date of the death or disability). If the Company does not exercise such option within such period, the remaining Members shall have an additional sixty (60) days to purchase such Interest, pro rata in proportion to their respective Percentage Interests, at Fair Value on the same terms.</p>
<p><strong>9.2 Bankruptcy of a Member.</strong> If any Member becomes a "Bankrupt Member" (meaning such Member has: (a) made an assignment for the benefit of creditors; (b) filed a voluntary bankruptcy petition; (c) become the subject of an order for relief under any federal or state bankruptcy or insolvency proceeding; (d) had a trustee, receiver, or liquidator appointed over all or any substantial part of such Member's properties that is not dismissed within ninety (90) days; or (e) failed to have any involuntary petition in bankruptcy dismissed within ninety (90) days), the Company shall have the option, exercisable by written notice within sixty (60) days after receipt of notice of such event, to purchase all of the Bankrupt Member's Interest at Fair Value.</p>
<p><strong>9.3 Determination of Fair Value.</strong> The "Fair Value" of a Member's Interest shall be the amount that would be distributable to such Member in the event that all Company assets were sold at their appraised fair market value and the proceeds, net of all Company liabilities, were distributed to the holders of all Interests pursuant to the waterfall provisions of Section 4.2 of this Agreement. If the parties cannot agree on Fair Value within thirty (30) days, Fair Value shall be determined by an independent MAI-designated appraiser mutually agreed upon by the parties, whose determination shall be final and binding. If the parties cannot agree on an appraiser within fifteen (15) days, each party shall select one appraiser, and the two appraisers so selected shall select a third appraiser, whose determination shall be final and binding. The cost of any appraisal shall be borne equally by the selling Member (or such Member's estate or representative) and the purchasing party.</p>
<p><strong>9.4 Payment Terms.</strong> Unless otherwise agreed, the purchase price for any Interest acquired under this Article IX shall be paid as follows: (a) ten percent (10%) of the purchase price shall be paid at closing in cash or certified funds; and (b) the remaining ninety percent (90%) shall be paid pursuant to a promissory note bearing interest at the prime rate published in <em>The Wall Street Journal</em> on the date of closing, payable in thirty-six (36) equal monthly installments of principal and interest, commencing thirty (30) days after closing, secured by a pledge of the Interest acquired.</p>
<p><strong>9.5 Forced Buy-Sell Provision.</strong></p>
<ol type="a" style="margin-left: 20px;">
  <li style="margin-bottom: 8px;">At any time after the first anniversary of the Effective Date of this Agreement, either the Managing Member or Limited Members holding a Majority-in-Interest (the "Initiating Party") may, by delivery of a written notice (the "Buy-Sell Notice") to the other Members (the "Responding Parties"), initiate the buy-sell procedures set forth in this Section 9.5.</li>
  <li style="margin-bottom: 8px;">The Buy-Sell Notice shall state: (i) that it constitutes a Buy-Sell Notice under this Section; (ii) the price per percentage point of Interest (the "Unit Price") at which the Initiating Party is willing to purchase all Interests owned by the Responding Parties; and (iii) an irrevocable offer to, at the election of the Responding Parties, either purchase all Interests owned by the Responding Parties at the Unit Price, or sell all Interests owned by the Initiating Party to the Responding Parties at the Unit Price.</li>
  <li style="margin-bottom: 8px;">Within thirty (30) days after receipt of the Buy-Sell Notice (the "Response Period"), the Responding Parties shall deliver a written notice electing to either sell their Interests or purchase the Initiating Party's Interests at the Unit Price. If the Responding Parties fail to deliver a response within the Response Period, such failure shall be deemed an irrevocable election to sell their Interests to the Initiating Party at the Unit Price.</li>
  <li style="margin-bottom: 8px;">Closing of any purchase under this Section shall occur within sixty (60) days following the election or deemed election. The purchasing party shall pay the full purchase price in cash or certified funds at closing.</li>
</ol>

<p style="${hdr}">ARTICLE X<br>EXPULSION OF A MEMBER</p>
<p><strong>10.1 Grounds for Expulsion.</strong> A Member may be expelled from the Company by the affirmative vote of Members holding at least seventy-five percent (75%) of the Percentage Interests (not including the Interest held by the Member proposed to be expelled) if it is reasonably determined that such Member has: (a) willfully and materially violated any provision of this Agreement; (b) committed fraud, theft, embezzlement, or gross negligence against the Company or one or more Members; (c) been convicted of a felony; or (d) engaged in wrongful conduct that adversely and materially affects the business, reputation, or operations of the Company.</p>
<p><strong>10.2 Buyout of Expelled Member.</strong> An expelled Member shall be entitled to receive the Fair Value of such Member's Interest as determined under Section 9.3, less any offset for damages caused by the conduct giving rise to the expulsion, paid in accordance with the terms set forth in Section 9.4.</p>
<p><strong>10.3 Offset for Damages.</strong> The Company may offset any actual damages to the Company or its Members that were proximately caused by the misconduct of the expelled Member against any amounts distributable or otherwise payable by the Company to such expelled Member.</p>

<p style="${hdr}">ARTICLE XI<br>ACCOUNTING, RECORDS, AND TAX MATTERS</p>
<p><strong>11.1 Fiscal Year.</strong> The fiscal year of the Company shall be the calendar year.</p>
<p><strong>11.2 Books and Records.</strong> The Managing Member shall keep or cause to be kept proper and complete books of account and records of the Company, including: (a) a current list of the names, addresses, and Percentage Interests of all Members; (b) copies of federal, state, and local income tax returns for each year; (c) copies of this Agreement, the Certificate of Formation, and all amendments thereto; and (d) financial statements. Each Member shall have the right, upon reasonable advance notice and during normal business hours, to inspect and copy at such Member's expense any of the Company's books, records, and documents.</p>
<p><strong>11.3 Financial Reporting.</strong> The Managing Member shall furnish to each Member: (a) within 90 days after the end of each fiscal year, an annual report containing the Company's financial statements (balance sheet, income statement, statement of cash flows, and statement of Members' equity), prepared on an accrual basis in accordance with generally accepted accounting principles; and (b) quarterly updates on the status of the Property, material events, and a summary of distributions made or projected.</p>
<p><strong>11.4 Tax Returns and K-1s.</strong> The Managing Member shall cause the Company to file all required federal, state, and local tax returns and shall use commercially reasonable efforts to deliver a Schedule K-1 (IRS Form 1065) to each Member within 75 days after the end of each fiscal year. Each Member shall be responsible for filing their own individual tax returns and paying their own taxes on allocated Company income.</p>
<p><strong>11.5 Partnership Representative (BBA Audit Rules).</strong> The Managing Member is hereby designated as the "Partnership Representative" pursuant to Section 6223(a) of the Internal Revenue Code, as amended by the Bipartisan Budget Act of 2015 (the "BBA"). The Partnership Representative shall have sole authority to act on behalf of the Company in any federal tax audit or proceeding. The Partnership Representative shall keep the Members reasonably informed of any administrative or judicial proceedings. If the Company qualifies, the Partnership Representative may elect out of the centralized partnership audit regime under Section 6221(b) of the Code. If the Company does not elect out and an imputed underpayment is assessed, the Partnership Representative shall elect the "push-out" alternative under Section 6226 of the Code (passing the tax adjustment through to the Members for the reviewed year) unless the Partnership Representative determines in good faith that an alternative approach is more beneficial to the Members.</p>
<p><strong>11.6 Tax Elections.</strong> The Managing Member shall have the authority to make all tax elections on behalf of the Company, including but not limited to:</p>
<ol type="a" style="margin-left: 20px;">
...
<p><strong>11.7 Tax Classification.</strong> The Members intend that the Company shall be treated as a partnership for federal and applicable state income tax purposes. No Member shall take any action inconsistent with such treatment. The Company shall not file an election to be classified as a corporation under Treasury Regulation Section 301.7701-3.</p>
<p><strong>11.8 Withholding.</strong> The Company is authorized to withhold from distributions to a Member, or with respect to allocations to a Member, and to pay over to any federal, state, or local government any amounts required to be so withheld pursuant to applicable tax law. Any amounts so withheld shall be treated as distributions to the relevant Member for all purposes of this Agreement.</p>
<p><strong>11.9 UBTI Notice.</strong> Members that are tax-exempt entities (including IRAs, pension plans, and other benefit plans subject to ERISA) should be aware that the Company may generate unrelated business taxable income ("UBTI") due to the use of debt financing. Each such Member should consult its own tax advisor regarding the potential impact of UBTI on such Member's tax-exempt status.</p>

<p style="${hdr}">ARTICLE XII<br>ADDITIONAL CAPITAL AND DEFAULT</p>
<p><strong>12.1 No Obligation for Additional Capital.</strong> Except as provided in Section 12.2, no Member shall be required to make any additional capital contribution beyond such Member's initial Capital Contribution as set forth on Schedule A.</p>
<p><strong>12.2 Capital Calls.</strong> If the Managing Member determines in good faith that additional capital is necessary for the Company to meet its obligations or to preserve the value of the Property, the Managing Member may issue a capital call notice to all Members, specifying the amount requested and the purpose. Capital calls shall be pro-rata in accordance with each Member's Percentage Interest. Each Member shall have fifteen (15) business days from receipt of such notice to fund their pro-rata share.</p>
<p><strong>12.3 Failure to Fund (Default).</strong> If a Member fails to fund a capital call within the specified period (a "Defaulting Member"), the non-defaulting Members may, but are not required to, fund the Defaulting Member's shortfall. In such event, at the election of the Managing Member: (a) the Defaulting Member's Percentage Interest may be diluted proportionally to reflect the unfunded amount; (b) the funding provided by non-defaulting Members may be treated as a loan to the Defaulting Member at an annual interest rate of <strong>${defaultInterest}%</strong>, secured by the Defaulting Member's Interest; or (c) the Defaulting Member may be required to sell their Interest to the non-defaulting Members at a discount of <strong>${buyoutDiscount}%</strong> from its fair market value.</p>

<p style="${hdr}">ARTICLE XIII<br>DISSOLUTION AND WINDING UP</p>
<p><strong>13.1 Events of Dissolution.</strong> The Company shall be dissolved upon the earliest to occur of the following: (a) the sale, exchange, or other disposition of all or substantially all of the Company's assets; (b) the unanimous written consent of the Members; (c) the entry of a decree of judicial dissolution; (d) the occurrence of any other event that makes it unlawful for the business of the Company to be continued; or (e) the bankruptcy, dissolution, or removal of the Managing Member, unless within ninety (90) days after such event a Majority-in-Interest of the remaining Members elect to continue the Company and appoint a successor Managing Member.</p>
<p><strong>13.2 Winding Up.</strong> Upon dissolution, the Managing Member (or, if the Managing Member is unable or unwilling to serve, a liquidating trustee appointed by a Majority-in-Interest of the Limited Members) shall wind up the affairs of the Company with reasonable promptness. During the winding up period, the Company shall continue solely for the purpose of winding up its affairs, collecting its assets, satisfying its liabilities, and distributing its remaining assets to the Members.</p>
<p><strong>13.3 Order of Liquidating Distributions.</strong> The assets of the Company, or the proceeds from the liquidation thereof, shall be applied and distributed in the following order: (a) first, to the payment of debts and liabilities of the Company (including debts owed to Members) and the expenses of liquidation; (b) second, to the establishment of any reserves that the liquidating party deems reasonably necessary for contingent or unforeseen liabilities of the Company; and (c) third, to the Members in accordance with the distribution priorities set forth in Section 4.2 of this Agreement.</p>
<p><strong>13.4 Final Accounting.</strong> Within a reasonable time following the completion of the liquidation, the liquidating party shall supply to each Member a statement that sets forth the assets and liabilities of the Company as of the date of dissolution, the manner in which the Company's assets were liquidated, and the amounts distributed to each Member.</p>
<p><strong>13.5 Certificate of Cancellation.</strong> Upon completion of the winding up and distribution of all Company assets, the Managing Member (or liquidating trustee) shall file a Certificate of Cancellation with the appropriate state authority.</p>

<p style="${hdr}">ARTICLE XIV<br>STATE-SPECIFIC PROVISIONS</p>
${stateSection}

<p style="${hdr}">ARTICLE XV<br>GENERAL PROVISIONS</p>
<p><strong>15.1 Amendments.</strong> This Agreement may be amended only by a written instrument signed by the Managing Member and approved by a Majority-in-Interest (over 50%) of the Limited Members; provided, however, that no amendment that adversely affects the economic rights of a Member (including distribution priorities, allocation of profits and losses, or capital account adjustments) shall be effective without the written consent of such affected Member. The Managing Member may amend Schedule A without Member consent to reflect the admission or withdrawal of Members and changes in Capital Contributions.</p>
<p><strong>15.2 Entire Agreement.</strong> This Agreement, including all exhibits and schedules attached hereto, constitutes the entire agreement among the parties regarding the subject matter hereof and supersedes all prior negotiations, representations, warranties, commitments, and understandings.</p>
<p><strong>15.3 Counterparts; Electronic Signatures.</strong> This Agreement may be executed in counterparts, each of which shall be deemed an original, and all of which together shall constitute one agreement. Signatures delivered by electronic means (including DocuSign or similar platforms) shall be binding and effective.</p>
<p><strong>15.4 Governing Law.</strong> This Agreement shall be governed by and construed in accordance with the laws of the State of ${state}, without regard to conflicts of law principles.</p>
<p><strong>15.5 Dispute Resolution.</strong> Any dispute, controversy, or claim arising out of or relating to this Agreement shall first be submitted to mediation administered by the American Arbitration Association or JAMS under its applicable mediation rules. If mediation is unsuccessful within sixty (60) days, any unresolved dispute shall be submitted to binding arbitration in the county where the Company's principal office is located, conducted by a single arbitrator in accordance with the Commercial Arbitration Rules of the American Arbitration Association. The arbitrator's award shall be final and binding and may be entered as a judgment in any court of competent jurisdiction. The prevailing party shall be entitled to recover its reasonable attorneys' fees and costs.</p>
<p><strong>15.6 Confidentiality.</strong> Each Member agrees to maintain the confidentiality of all non-public information regarding the Company, the Property, the Members, and the terms of this Agreement, and shall not disclose such information to any third party without the prior written consent of the Managing Member, except: (a) to such Member's legal, tax, and financial advisors who agree to maintain confidentiality; (b) as required by law or regulation; or (c) as necessary in connection with a permitted transfer of such Member's Interest.</p>
<p><strong>15.7 Notices.</strong> All notices, requests, demands, and other communications under this Agreement shall be in writing and shall be deemed duly given when delivered personally, sent by email with confirmation of receipt, or sent by nationally recognized overnight courier, to the addresses set forth on Schedule A or such other address as a party may designate in writing.</p>
<p><strong>15.8 Severability.</strong> If any provision of this Agreement is held to be invalid or unenforceable, the remaining provisions shall continue in full force and effect and shall be construed as if the invalid provision had not been included.</p>
<p><strong>15.9 Waiver.</strong> No waiver of any provision of this Agreement shall be effective unless in writing, and no waiver shall constitute a continuing waiver or a waiver of any other provision.</p>
<p><strong>15.10 Power of Attorney.</strong> Each Limited Member hereby irrevocably constitutes and appoints the Managing Member as such Member's attorney-in-fact, with full power and authority, to execute, acknowledge, swear to, file, and record on such Member's behalf any documents necessary to carry out the purposes of this Agreement, including amendments to the Certificate of Formation, and any documents required to effect the dissolution and termination of the Company.</p>
<p><strong>15.11 ERISA.</strong> The Company is not intended to hold "plan assets" of any employee benefit plan subject to the Employee Retirement Income Security Act of 1974, as amended ("ERISA"). If Benefit Plan Investors (as defined in 29 C.F.R. § 2510.3-101) hold 25% or more of the value of any class of equity interest in the Company, the Managing Member shall take reasonable steps to reduce such percentage below 25% or to ensure compliance with ERISA.</p>
<p><strong>15.12 No Third-Party Beneficiaries.</strong> This Agreement is for the sole benefit of the Members and their permitted successors and assigns. Nothing in this Agreement shall confer upon any other person any legal or equitable right, benefit, or remedy.</p>
